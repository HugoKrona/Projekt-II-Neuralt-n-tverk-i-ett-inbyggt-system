 ...
 ******************************************************************************/
template <typename T> T getNumber(const T min = 0, const T max = 100);
 ...
 ******************************************************************************/
template <typename T>
void initRandom(std::vector<T> &vector, const std::size_t size, const T min = 0, const T max = 100);
...
void initRandom(std::vector<std::vector<T>> &vector, const std::size_t columnCount,
                const std::size_t rowCount, const T min = 0, const T max = 100);
 ...
 ******************************************************************************/
template <typename T>
void print(const std::vector<T> &vector, std::ostream &ostream = std::cout, const char *end = "\n",
 ...
 ******************************************************************************/
template <typename T>
void print(const std::vector<std::vector<T>> &vector, std::ostream &ostream = std::cout,
           const char *end = "\n", const std::size_t decimalCount = 1U);
 ...
 ******************************************************************************/
template <typename T = std::int32_t> constexpr T round(const double number);
